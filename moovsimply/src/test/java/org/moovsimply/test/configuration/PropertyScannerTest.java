...
package org.moovsimply.test.configuration;
...
import org.moovsimply.configuration.MoovSimplyProperties;
...
public class PropertyScannerTest {
	...
	@Test public void test_scan_for_home_dir() throws IOException {
		MoovSimplyProperties myprops = PropertyScanner.scanPropertyFile();
